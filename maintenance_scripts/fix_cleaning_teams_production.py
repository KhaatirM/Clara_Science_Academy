#!/usr/bin/env python3
"""
Production Fix Script for Cleaning Teams
Run this on Render shell to fix the team assignments
"""
...
def main():
    with app.app_context():
        print("="*70)
        print("PRODUCTION CLEANING TEAM FIX")
        print("="*70)
        
        # Step 1: Find and remove Mason Jackson from Team 2
        print("\n[1] Removing Mason Jackson from Cleanup Team 2...")
        ...
        # Step 2: Add Major Sharif to Team 2
        print("\n[2] Adding Major Sharif to Cleanup Team 2...")
        ...
        if major and team_2:
            ...
            if existing:
                ...
                new_member.role = "Wipe Down Team - Wipe down tables and surfaces in all classrooms"
        ...
        # Step 3: Assign specific duties to all team members
        ...
        if team_1:
            ...
            team_1_assignments = {
                ...
                "Mason Jackson": "General Cleaning - Assist with all cleaning tasks"
            }
