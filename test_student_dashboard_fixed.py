#!/usr/bin/env python3
"""
Simple test script to verify student dashboard route works after fixing route references.
"""
...
def test_student_dashboard_route_fixed():
    """Test that the student dashboard route works without errors after fixing route references."""
    app = create_app()
    
    with app.app_context():
        try:
            print("=== TESTING STUDENT DASHBOARD ROUTE (FIXED) ===\n")
            ...
            print("✅ Route references have been fixed")
...
if __name__ == '__main__':
    test_student_dashboard_route_fixed()
